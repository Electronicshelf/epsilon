...
def test_ocr_backend():
    ...
    try:
        from models.ocr import get_ocr_backend, OCRModel, TesseractOCRBackend
        ...
        # Test OCRModel wrapper
        print("\n3. Testing OCRModel wrapper...")
        ocr_model = OCRModel()
        signals = ocr_model.extract_text(test_image)
